let fs,jwt,AsyncLock,InputError,AccessError;_dc2‍.x([["save",()=>save],["reset",()=>reset],["resourceLock",()=>resourceLock],["getEmailFromAuthorization",()=>getEmailFromAuthorization],["login",()=>login],["logout",()=>logout],["register",()=>register],["assertOwnsListing",()=>assertOwnsListing],["assertOwnsBooking",()=>assertOwnsBooking],["addListing",()=>addListing],["getListingDetails",()=>getListingDetails],["getAllListings",()=>getAllListings],["updateListing",()=>updateListing],["removeListing",()=>removeListing],["publishListing",()=>publishListing],["unpublishListing",()=>unpublishListing],["leaveListingReview",()=>leaveListingReview],["makeNewBooking",()=>makeNewBooking],["getAllBookings",()=>getAllBookings],["removeBooking",()=>removeBooking],["acceptBooking",()=>acceptBooking],["declineBooking",()=>declineBooking]]);_dc2‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_dc2‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_dc2‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_dc2‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);
  ...
  new Promise((resolve, reject) => {
    lock.acquire('saveData', () => {
      try {
       ...
       const save = () => update(users, listings, bookings);
       const reset = () => {
  update({}, {}, {});
  users = {};
  listings = {};
...
const newListingPayload = (title, owner, address, price, thumbnail, metadata) => ({
  ...
  postedOn: null,
       ...
       const assertOwnsListing = (email, listingId) =>
  resourceLock((resolve, reject) => {
    if (!(listingId in listings)) {
      ...
      resolve();
       ...
       const assertOwnsBooking = (email, bookingId) =>
  resourceLock((resolve, reject) => {
    if (!(bookingId in bookings)) {
      ...
      resolve();
       ...
       const addListing = (title, email, address, price, thumbnail, metadata) =>
  resourceLock((resolve, reject) => {
    if (title === undefined) {
  ...
  resourceLock((resolve, reject) => {
    resolve(
      Object.keys(listings).map((key) => ({
       ...
       const updateListing = (listingId, title, address, thumbnail, price, metadata) =>
  resourceLock((resolve, reject) => {
    if (address) {
  ...
  resourceLock((resolve, reject) => {
    ...
    resolve();
       ...
       const publishListing = (listingId, availability) =>
  resourceLock((resolve, reject) => {
  ...
  resourceLock((resolve, reject) => {
    if (listings[listingId].published === false) {
      ...
      resolve();
       ...
       const leaveListingReview = (email, listingId, bookingId, review) =>
  resourceLock((resolve, reject) => {
    if (!(bookingId in bookings)) {
      reject(new InputError('Invalid booking ID'));
...
const newBookingPayload = (owner, dateRange, totalPrice, listingId) => ({
  ...
  status: 'pending',
       ...
       const makeNewBooking = (owner, dateRange, totalPrice, listingId) =>
  resourceLock((resolve, reject) => {
    if (!(listingId in listings)) {
      reject(new InputError('Invalid listing ID'));
  ...
  resourceLock((resolve, reject) => {
    ...
    resolve();
       ...
       const acceptBooking = (owner, bookingId) =>
  resourceLock((resolve, reject) => {
    if (!(bookingId in bookings)) {
      reject(new InputError('Invalid booking ID'));
    } else if (
      ...
      resolve();
       ...
       const declineBooking = (owner, bookingId) =>
  resourceLock((resolve, reject) => {
    if (!(bookingId in bookings)) {
      reject(new InputError('Invalid booking ID'));
    } else if (
